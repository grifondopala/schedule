...
import {AnotherSourceBtn} from "./components/another-source-btn";
    ...
    return(
        <div className={'flex items-center justify-center flex-col h-screen'}>
            <div className={'flex flex-row gap-[150px] items-center'}>
                <img className={'w-[400px] rounded-full border-2 max-[1150px]:hidden'} src={'/images/auth-page/auth.jpg'} alt={'auth'}/>
            ...
            <div className={'flex flex-row gap-[150px] items-center items-center'}>
                ...
                <div className={'w-[320px] flex flex-row gap-[15px] items-center'}>
                    ...
                    <AnotherSourceBtn imageSrc={'/images/auth-page/icons8-google-24.png'} alt={'google'} color={'#ea202e'}/>
                    <AnotherSourceBtn imageSrc={'/images/auth-page/icons8-facebook-f-24.png'} alt={'facebook'} color={'#396097'}/>
                    <AnotherSourceBtn imageSrc={'/images/auth-page/icons8-twitter-24.png'} alt={'twitter'} color={'#1ea2e2'}/>
                </div>
            </div>
        </div>
    )
