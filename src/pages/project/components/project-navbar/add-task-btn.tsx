...
export function AddTaskBtn(){
    ...
    return(
        <>
            <div className={'w-[150px] h-[35px] flex flex-row items-center'}>
                ...
                <div className={'w-[32px] h-full border-2 border-l-0 rounded-r-md flex flex-row items-center justify-center cursor-pointer hover:bg-gray-100'}
                    ...
                    <img className={'w-[16px] h-[16px]'} src={'/images/arrow-down-sign-to-navigate.png'} alt={'another'}/>
                </div>
            </div>
            <div className={`absolute ml-[120px] mt-[75px] border-2 rounded-md w-[150px] h-[35px] flex flex-row items-center justify-center 
                            ${isDropShown ? 'visible' : 'hidden'}`}>
                <p>Add new section</p>
            </div>
        </>
    )
